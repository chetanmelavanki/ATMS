...
<head>
    ...
    <title>Delete Faculty User</title>
...
<body>
    ...
    <!-- Main Content -->
    <div class="container">
        <h4 class="mb-4">Delete Faculty User</h4>
        <form action="delete_faculty.jsp" method="post">
            ...
            <button type="submit" class="btn btn-danger">Delete Faculty User</button>
        </form>
        ...
        <%
            ...
            if (facultyId != null && !facultyId.trim().isEmpty()) {
                try {
                    ...
                    // Delete query to remove faculty based on Faculty ID
                    String sql = "DELETE FROM FACULTY_USER WHERE Faculty_Id = ?";
                    ...
                    if (rowsDeleted > 0) {
                        ...
                        message = "Error: Faculty user not found or deletion failed.";
                    }
